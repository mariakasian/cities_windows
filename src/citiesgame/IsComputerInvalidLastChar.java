...
public class IsComputerInvalidLastChar {
    public static char isComputerInvalidLastChar(String lastComputerWord) {
        ...
        if (lastComputerWordChar == 'ь' || lastComputerWordChar == 'и' || lastComputerWordChar == 'й' || lastComputerWordChar == 'ї') {
            System.out.println("Так як немає міста на літеру '" + lastComputerWordChar + "', то введіть місто на літеру 'і'.");
